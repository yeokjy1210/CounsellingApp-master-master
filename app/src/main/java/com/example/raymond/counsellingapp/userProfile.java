...
public class userProfile extends AppCompatActivity
    ...
    TextView txtStuName, txtStuEmail,contentStuName,contentStuEmail,contentStuPhone;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        contentStuName.setText("Name : "+prefs.getString("studentName","No name"));
        contentStuEmail.setText("Email : "+prefs.getString("studentEmail","No email"));
        contentStuPhone.setText("Date of birth : "+prefs.getString("studentDOB","No dob"));
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        switch (id){
            ...
            case R.id.nav_signout:
                Intent s= new Intent(userProfile.this,aboutUs.class);
                startActivity(s);
                break;
        }
